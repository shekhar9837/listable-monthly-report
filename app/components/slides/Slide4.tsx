    ...
    <Slide>
      <div className="flex h-full flex-col  p-8 md:p-11">
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-sm  font-medium  text-secondary tracking-tight uppercase"
        >
        ...
        <motion.h2
          ...
          transition={{ duration: 0.5, ease: "easeInOut" }}
          viewport={{ once: true }}
          className="text-3xl md:text-4xl font-medium leading-tight tracking-tight mt-3"
        >
          Four Dimensions of AI Presence
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, filter: "blur(10px)", y: 10 }}
          whileInView={{ opacity: 1, filter: "blur(0px)", y: 0 }}
          transition={{ duration: 0.5, ease: "easeInOut" }}
          viewport={{ once: true }}
          className="max-w-xl text-md tracking-tight text-secondary mt-3"
        >
            ...
            >
              <div className="flex items-center justify-center gap-2">
                ...
                <motion.p
                  ...
                  viewport={{ once: true }}
                  className="text-md font-medium text-primary tracking-tight"
                >
                  {item.title}
                </motion.p>
              </div>
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="mt-auto text-sm tracking-tight text-secondary"
        >
